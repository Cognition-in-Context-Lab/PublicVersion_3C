...
omit_df_m1_outliers <-omit_df[!(omit_df$id=="59" | omit_df$id=="156" | omit_df$id=="212" | omit_df$id=="26" |  omit_df$id=="262" |  omit_df$id=="44"  | omit_df$id=="132" | omit_df$id=="157" | omit_df$id=="10" | omit_df$id=="15" |omit_df$id=="109" | omit_df$id=="253" | omit_df$id=="51" | omit_df$id=="238" ),]
                                

Model1.5 <- lm(logCOVID_DoG_index ~ SDRS_Sum_scaled, data =omit_df_m1_outliers)

outlierTest(Model1.5)
...
omit_df_m2_outliers <-omit_df[!(omit_df$id=="156" | omit_df$id=="212" | omit_df$id=="26" |  omit_df$id=="262" |  omit_df$id=="44"  | omit_df$id=="132" | omit_df$id=="157" | omit_df$id=="10" | omit_df$id=="15" |omit_df$id=="109" | omit_df$id=="253" | omit_df$id=="51" | omit_df$id=="238" | omit_df$id=="318" | omit_df$id=="59" | omit_df$id=="315" ),]


Model2.5 <- lm(logCOVID_DoG_index ~ SDRS_Sum_scaled + Stress_index + Impacts_index, data =omit_df_m2_outliers)

outlierTest(Model2.5)
...
# omit_df$id=="10" | omit_df$id=="15" | omit_df$id=="132" | omit_df$id=="262" | omit_df$id=="157" | omit_df$id=="44" | omit_df$id=="253" | omit_df$id=="26" | omit_df$id=="109" | omit_df$id=="51" | omit_df$id=="238"),]
